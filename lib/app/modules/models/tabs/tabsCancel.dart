...
class TabsCancel extends StatefulWidget {
  const TabsCancel({super.key});

  @override
  State<TabsCancel> createState() => _TabsCancelState();
}

class _TabsCancelState extends State<TabsCancel> {
  ...
  Future<void> getDataRiwayatCancel() async {
    Uri url = Uri.parse(API.riwayatDibatalkan);

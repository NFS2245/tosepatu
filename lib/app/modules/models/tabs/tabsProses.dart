...
class TabsProses extends StatefulWidget {
  const TabsProses({super.key});

  @override
  State<TabsProses> createState() => _TabsProsesState();
}

class _TabsProsesState extends State<TabsProses> {
  ...
  Future<void> getDataRiwayatproses() async {
    Uri url = Uri.parse(API.riwayatProses);
